export default {
  ...
  TRANSACTION: {
    ...
    TYPES: {
      ...
      // Magistrate 2.0
      BUSINESS_ENTITY_REGISTRATION: "Business Registration (AIP36)",
      BUSINESS_ENTITY_RESIGNATION: "Business Resignation (AIP36)",
      BUSINESS_ENTITY_UPDATE: "Business Update (AIP36)",
      DEVELOPER_ENTITY_REGISTRATION: "Developer Registration (AIP36)",
      DEVELOPER_ENTITY_RESIGNATION: "Developer Registration (AIP36)",
      DEVELOPER_ENTITY_UPDATE: "Developer Registration (AIP36)",
      CORE_PLUGIN_ENTITY_REGISTRATION: "Delegate Registration (AIP36)",
      CORE_PLUGIN_ENTITY_RESIGNATION: "Delegate Resignation (AIP36)",
      CORE_PLUGIN_ENTITY_UPDATE: "Delegate Update (AIP36)",
      DESKTOP_PLUGIN_ENTITY_REGISTRATION: "Core Plugins Registration (AIP36)",
      DESKTOP_PLUGIN_ENTITY_RESIGNATION: "Core Plugins Resignation (AIP36)",
      DESKTOP_PLUGIN_ENTITY_UPDATE: "Core Plugins Update (AIP36)",
      DELEGATE_ENTITY_REGISTRATION: "Desktop Wallet Plugins Registration (AIP36)",
      DELEGATE_ENTITY_RESIGNATION: "Desktop Wallet Plugins Resignation (AIP36)",
      DELEGATE_ENTITY_UPDATE: "Desktop Wallet Plugins Update (AIP36)",
      // Magistrate 1.0
