export default {
  ...
  TRANSACTION: {
    ...
    TYPES: {
      ...
      DEVELOPER_ENTITY_RESIGNATION: "Developer Resignation (AIP36)",
      DEVELOPER_ENTITY_UPDATE: "Developer Update (AIP36)",
      CORE_PLUGIN_ENTITY_REGISTRATION: "Core Plugin Registration (AIP36)",
      CORE_PLUGIN_ENTITY_RESIGNATION: "Core Plugin Resignation (AIP36)",
      CORE_PLUGIN_ENTITY_UPDATE: "Core Plugin Update (AIP36)",
      DESKTOP_PLUGIN_ENTITY_REGISTRATION: "Desktop Plugin Registration (AIP36)",
      DESKTOP_PLUGIN_ENTITY_RESIGNATION: "Desktop Plugin Resignation (AIP36)",
      DESKTOP_PLUGIN_ENTITY_UPDATE: "Desktop Plugin Update (AIP36)",
      DELEGATE_ENTITY_REGISTRATION: "Delegate Registration (AIP36)",
      DELEGATE_ENTITY_RESIGNATION: "Delegate Resignation (AIP36)",
      DELEGATE_ENTITY_UPDATE: "Delegate Update (AIP36)",
      // Magistrate 1.0
