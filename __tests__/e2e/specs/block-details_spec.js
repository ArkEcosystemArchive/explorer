describe('Block Details', () => {
  ...
  it('should be possible to navigate to next block and back', () => {
    ...
    cy.get('span.has-tooltip').contains('3487084709104787070').should('be.visible')
    cy.get('button').contains('Next block').click()

    cy.get('span.has-tooltip').contains('12152817243754268433').should('be.visible')
    cy.get('button').contains('Previous block').click()
