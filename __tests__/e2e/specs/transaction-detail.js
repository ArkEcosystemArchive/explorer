...
module.exports = {
  ...
  'transaction detail page should be available': function (browserName) {
    const devServer = browserName.globals.devServerURL + '/#/transaction/818c157383c814a353efbfbbdd3dccabb13cb35e156bb70d31e77248166657a7'
  ...
  'it should be possible to copy the transaction id': function (browserName) {
    browserName
      .useCss()
  ...
  'it should be possible to click on the recipient': function (browserName) {
    const devServer = browserName.globals.devServerURL + '/#/transaction/818c157383c814a353efbfbbdd3dccabb13cb35e156bb70d31e77248166657a7'
  ...
  'it should be possible to click on the transaction block id': function (browserName) {
    const devServer = browserName.globals.devServerURL + '/#/transaction/818c157383c814a353efbfbbdd3dccabb13cb35e156bb70d31e77248166657a7'
  ...
  'it should emojify the vendor field': function (browserName) {
    const devServer = browserName.globals.devServerURL + '/#/transaction/80aa5f3c1520481c26ab606b9e15fae1c3424dbabbce3719fc8f381e8bb19d29'
  ...
  // 'it should be possible to show the amount tooltip': function(browserName) {
  //   const devServer = browserName.globals.devServerURL + '/#/transaction/818c157383c814a353efbfbbdd3dccabb13cb35e156bb70d31e77248166657a7'
