...
describe('Mixins > Currency', () => {
  ...
  describe('rawCurrency', () => {
    ...
    it('should display non-cryptocurrency always with 2 digits', () => {
      ...
      expect(wrapper.vm.rawCurrency(10.1, 'USD')).toEqual(displayFiat(10.10))
      expect(wrapper.vm.rawCurrency(10, 'USD')).toEqual(displayFiat(10.00))
    })
  })
  ...
  describe('readableCrypto', () => {
    ...
    it('should return crypto value in readable format, including symbol', () => {
      ...
      expect(wrapper.vm.readableCrypto(10.12345678912345 * Math.pow(10, 8), true)).toEqual(displayCrypto(10.12345679) + ' Ѧ')
